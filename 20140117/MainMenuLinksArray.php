...
$MenuItems['Header']['Transactions'][$MenuItems['HQ']['Transactions']['URL'][13]] = _('Stock Valuation - National');
$MenuItems['Header']['Transactions'][$MenuItems['HQ']['Transactions']['URL'][17]] = _('Price Lists and Modifications');
$MenuItems['Header']['Transactions'][$MenuItems['HQ']['Transactions']['URL'][23]] = _('Manufacturing');
