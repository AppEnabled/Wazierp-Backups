...
$filename = $_SESSION['reports_dir'] . '/CrdPurchaseHistory.csv';
...
*/
        ...
        echo "</table><div class='centre'><input type=Submit Name='PrintPDF' Value='" . _('Print PDF') . "'></div>";
       // echo "<div class='centre'><a href='" . $rootpath . '/' . $_SESSION['reports_dir'] . "/Inventoryvaluation.csv'>" . _('click here') . '</a> ' . _('to export all to csv') . '</td></div>';
    }
    //}
    include('includes/footer.inc');
