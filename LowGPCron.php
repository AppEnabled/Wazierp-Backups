...
// --------------------
$DisplayTotalUnitCost = 0;
$DisplayTotalSellingPrice = 0;
while ($LowGPItems = mysql_fetch_array($Result)) {
   ...
   */
    ...
    $DisplayTotalUnitCost += $LowGPItems['unitcost'];
    $DisplayUnitCost = number_format($LowGPItems['unitcost'],2);
    $DisplayTotalSellingPrice += $LowGPItems['sellingprice'];
...
$message.= '<small style="color:#666">Total value R <b><font color="green">' . number_format($DisplayTotalUnitCost, 2, '.', ' ') . '</b></font>
             </small>
           <br />';
/*Debtors Creditor Ratio : Debtors � Creditors */
$message.= '<small style="color:#666">Total Cost R <b><font color="green">' . number_format($DisplayTotalSellingPrice, 2, '.', ' ') . '</b></font>
             </small>
           <br />';
$message.= '</p>';
